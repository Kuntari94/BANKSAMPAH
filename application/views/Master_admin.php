...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Bank Sampah Gemah Ripah -  Admin</title>
		...
		<div id="navbar" class="navbar navbar-default          ace-save-state">
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="<?= site_url().'/Admin/Admin' ;?>" class="navbar-brand">
						<small>
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<!--	<div class="sidebar-shortcuts" id="sidebar-shortcuts">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="<?=site_url().'/Admin/Formulir/Input_formulir' ?>">
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="<?= site_url().'/Admin/Setoran_nasabah'?>">
							...
							<li class="">
								<a href="<?= site_url().'/Admin/Setoran_pengepul'?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Slip Setoran Pengepul
								</a>
					...
					<li class="">
						<a href="<?= site_url().'/Admin/Buku_tabungan'?>">
							<i class="menu-icon fa fa-book"></i>
							<span class="menu-text"> Buku Tabungan </span>
						</a>
						<b class="arrow"></b>
					</li>
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="<?= site_url().'/Admin/Sampah/List_sampah'?> ">
											<i class="menu-icon fa fa-caret-right"></i>
									Data Sampah
								</a>
					...
					<li class="">
						<a href="<?= site_url().'/Admin/Pengepul'?>">
							<i class="menu-icon fa fa-cogs"></i>
							<span class="menu-text"> Data Pengepul </span>
						</a>
						<b class="arrow"></b>
					</li>
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="<?= site_url().'/Admin/Laporan/Laporan_harian'?>">
							...
							<li class="">
								<a href="<?= site_url().'/Admin/Laporan/Laporan_pengepul'?>">
							...
							<li class="">
								<a href="<?= site_url().'/Admin/Laporan/Laporan_bulanan'?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Laporan Bulanan
								</a>
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="<?= site_url().'/Admin/Admin/Daftar_admin'?>">
							...
							<li class="">
								<a href="<?= site_url().'/Admin/Saldo_minimum' ?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Saldo minimum
								</a>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<?php 
								$message = $this->session->flashdata('info-sukses'); 
								if(@$message != '') :
									?>
